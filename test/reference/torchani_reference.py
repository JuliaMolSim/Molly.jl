...
Usage:
  ...
  python test/reference/torchani_reference.py
  python test/reference/torchani_reference.py --skip-protein    # Skip slow protein run
  python test/reference/torchani_reference.py --skip-weights    # Skip HDF5 export
"""
