...
# (Former Test 12 "6mrr protein energy, first 50 atoms" removed: the full-protein Test 13 below
#  exercises the same large-system path and cross-validates against TorchANI, so it subsumes it.)
